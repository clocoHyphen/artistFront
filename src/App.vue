<template>
  <nav>
    ...
    <router-link v-if="store.userData?.role_id == 'artistmanager'" to="/newArtist"
      >New Artist</router-link
    >
    <router-link v-if="store.userData?.role_id == 'admin'" to="/newUser">New User</router-link>
    <router-link v-if="store.userData?.role_id == 'artist'" to="/musicDash"
      >Musics List</router-link
    >
    <router-link v-if="store.userData?.role_id == 'artist'" to="/newMusic">New Music</router-link>
    <router-link v-if="store.userData?.role_id == 'artistmanager'" to="/artistDash"
      >Artist</router-link
    >
